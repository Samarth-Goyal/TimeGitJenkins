...
//			"Enter a time in the format hh:mm:ss:mm", "Enter Time",
...
//					"Please enter the time in the form hh:mm:ss:mm",
...
//	}
	...
	public static int getTotalSeconds(String time)throws NumberFormatException, StringIndexOutOfBoundsException {
		...
		// int milliseconds = getTotalMilliseconds(time);
